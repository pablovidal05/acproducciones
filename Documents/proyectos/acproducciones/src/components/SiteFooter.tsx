    ...
    <footer className="footer">
      <div className="footer-inner">
        ...
        <div className="footer-socials">
          ...
          {/* Instagram */}
          <a
            href="https://www.instagram.com/alfacorporativo_eventos"
            id="footer-instagram"
            className="footer-social-link"
            target="_blank"
            rel="noopener noreferrer"
      ...
      <div className="footer-bottom">
        <p>© {new Date().getFullYear()} Alfa Corporativo. Todos los derechos reservados.</p>
      </div>
    </footer>
  );
}
